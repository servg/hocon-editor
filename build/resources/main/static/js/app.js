...
$(function() {
    ...
    $flowMapColumns.on('click', '[data-action]', function() {
        ...
        else if (action === 'add-next') openStepEditor(null, { startsAfterStepId: id, openAfterSave: true });
    });
    ...
    function createEditorDraft(step, originalId, options) {
        ...
        var opts = $.extend({ startsAfterStepId: '', openAfterSave: false }, options);
        return {
    ...
    function renderStepEditor() {
        ...
        StepEditor.loadStepType(draft.step.type, function(typeDesc) {
            StepEditor.renderStepEditorModal($stepEditorBody, draft, state.processDraft.steps, typeDesc);
